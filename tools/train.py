...
def main():
    ...
    # model = torch.hub.load('yangsenius/TransPose:main', 'tph_a4_256x192', pretrained=True,is_train=True)
    # model.final_layer =  torch.nn.Conv2d(192, 24, kernel_size=(1, 1), stride=(1, 1))
    # pretrain_part = []
    # for name, param in model.named_parameters():
    #     if 'final_layer' not in name:
    #         pretrain_part.append(param)
    ...
    print("training")
    print(begin_epoch,cfg.TRAIN.END_EPOCH)
